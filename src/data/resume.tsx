...
export const DATA = {
  ...
  summary: `I'm a **Principal Product Designer** with **16+ years of experience** leading product design across enterprise software, health tech, and consumer platforms. I specialize in turning high-complexity systems — clinical workflows, order management, payroll, and AI-assisted tooling — into interfaces that are fast, intuitive, and built to scale.

  My work has measurably improved team efficiency by up to **40%**, and I bring the same rigor to design systems, UX research, and cross-functional leadership. I've shipped products for **Fortune 500 companies, government agencies, and health systems** — always grounded in real user needs and built to outlast the sprint it shipped in.`,
  avatarUrl: "/me.png",
  metaDescription:
